...
if __name__ == '__main__':
    with app.app_context():
        ...
        #     admin_user.set_password('admin123') # <--- غيّر 'admin123' بكلمة مرور قوية!
    ...
    # هذا السطر مهم جداً. لا يجب تشغيل app.run هنا في الإنتاج مع Gunicorn.
    # سيتم تشغيل التطبيق بواسطة Gunicorn بناءً على ملف Procfile الذي أنشأناه سابقاً.
    # إذا كنت لا تزال تستخدمه لتشغيل محلي، فاتركه هكذا، لكنه لن يستخدم في Render.
